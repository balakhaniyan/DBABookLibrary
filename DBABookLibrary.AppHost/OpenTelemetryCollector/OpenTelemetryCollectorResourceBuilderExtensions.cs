...
namespace DBABookLibrary.AppHost.OpenTelemetryCollector;
...
public static class OpenTelemetryCollectorResourceBuilderExtensions
{
    ...
    private const string OTelCollectorImageName =
    ...
    public static IResourceBuilder<OpenTelemetryCollectorResource> AddOpenTelemetryCollector(
        this IDistributedApplicationBuilder builder, string name, string configFileLocation)
    {
        ...
        var resourceBuilder = builder.AddResource(resource)
            ...
            .WithEndpoint(targetPort: 4317, name: OpenTelemetryCollectorResource.OtlpGrpcEndpointName,
                scheme: isHttpsEnabled ? "https" : "http")
            .WithEndpoint(targetPort: 4318, name: OpenTelemetryCollectorResource.OtlpHttpEndpointName,
                scheme: isHttpsEnabled ? "https" : "http")
        ...
        {
            resourceBuilder.RunWithHttpsDevCertificate("HTTPS_CERT_FILE",
                "HTTPS_CERT_KEY_FILE", (_, __) =>
                {
